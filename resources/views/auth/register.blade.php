...
<head>
    ...
    <title>LeagueManager - Registro</title>
    <!-- Google Fonts -->
    ...
    <style>
        ...
        .bg-shapes {
            ...
            background: radial-gradient(circle at 80% 30%, rgba(255, 42, 95, 0.15) 0%, transparent 50%),
...
<body>
    ...
    <div class="login-card text-center">
        ...
        <h4 class="mb-4 font-weight-bold">Crear una cuenta</h4>
        ...
        <form action="{{ route('register') }}" method="POST" class="text-start">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <span class="input-group-text border-0" style="background: rgba(255,255,255,0.05); color: #a0a5ba;"><i class="bi bi-person"></i></span>
                    <input type="text" class="form-control border-start-0 ps-0" id="nombre" name="nombre" value="{{ old('nombre') }}" placeholder="Juan Pérez" required autofocus>
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="email" class="form-control border-start-0 ps-0" id="email" name="email" value="{{ old('email') }}" placeholder="tu@email.com" required>
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="password" class="form-control border-start-0 ps-0" id="password" name="password" placeholder="Mínimo 8 caracteres" required>
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <span class="input-group-text border-0" style="background: rgba(255,255,255,0.05); color: #a0a5ba;"><i class="bi bi-lock-fill"></i></span>
                    <input type="password" class="form-control border-start-0 ps-0" id="password_confirmation" name="password_confirmation" placeholder="Repite la contraseña" required>
                </div>
            </div>
        ...
        <div class="mt-4">
            ...
            <a href="{{ route('login') }}" class="back-link" style="color: var(--lm-primary);">Ya tengo cuenta</a>
        </div>
    </div>
